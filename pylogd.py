...
[14:14] <vikram> #msg nickserv register helicalspring vikramverma1997@gmail.com
[14:14] <vivek_> :/
...
[14:40] <kushal> next
[14:40] <jasonbraganza> Howdy folks, Iâ€™m Jason, 38, devoted husband, newly balding, love
...
[14:50] <cran-cg> <eof>
[14:50] <kushal> cran-cg, ðŸ‘ ðŸ‘ ðŸ‘ ðŸ‘ ðŸ‘ ðŸ‘ ðŸ‘
[14:50] <skarpy> !
...
[15:22] <kvy> don't confuse me
[15:22] <kvy> in
[15:22] <kvy> oss
[15:22] <kvy> <eof>
[15:22] <sayan> fhackdroid: that's my take :) Open Source & Algorithms
[15:22] <im_mohsin> Competitve programming involves solving programming problem in sites
like Hackerrank, codechef and websites alike
[15:23] <kvy> ok
[15:23] <kushal> next
[15:23] <kushal> next
[15:23] <wrik003__> how do i do this: "fhackdroid waiting to hear this answer"? <eof>
[15:23] <kushal> wrik003__, write this
[15:23] <kushal> wrik003__, /me is learning
[15:23] <bhavin192> wrik003__, type /me and message
[15:23] <kushal> next
[15:24] <kushal> next
[15:24] <nisha_> Kushal, how can i improve my computer knowledge because i does not know
much about computer science.<eof>
[15:24] <fhackdroid> wrik003__: magic :P
[15:24] <dodococo> I got my answers
[15:24] <ahole[m]> Does solving project Euler problem improve coding skills ?
[15:24] <ahole[m]> <eom>
[15:24] <kushal> nisha_, I hope this training will help you in that (slowly).
[15:24] <kushal> ahole[m], somewhat yes.
[15:24] <fhackdroid> sayan: thanks :)
[15:24] <sayan> nisha_: stay online after the sessions, read a lot, ask questions here
[15:24] <ahole[m]> !
[15:24] <kushal> next
[15:24] <acetakwas> ahole[m]:: It improves your algorithms skill
[15:24] <shankarj67> kvy, open source software, which one is available online for developers
to modify the codes and improve the performance of that software.
[15:25] <SpEcHiDeR> fhackdroid, why is it displaying like this:
@freenode_fhackdroid:matrix.org instead of your nickname?
[15:25] <nisha_> Kushal and Sayan thak you.
[15:25] <kushal> nisha_, like you are not from Computer Science background, anwesha is from
Legal background (she is a lawyer).
[15:25] <kushal> next
[15:25] <ahole[m]> Most of the problems under project Euler are mathematical problems how do
you apply them in real life use cases ?
[15:25] <ahole[m]> <eom>
[15:25] <kushal> ahole[m], I don't know how, I did not ever :)
[15:25] <kushal> ahole[m], I am bad at maths anyway.
[15:26] <im_mohsin> ahole[m], project Euler will help you very much in math concept as well
[15:26] <ahole[m]> Same here .
[15:26] <ahole[m]> <eom>
[15:26] <kushal> In one of the days we will learn about history of Free Software and other
important parts.
[15:26] <kvy> shankarj67 ok i was try codechef
[15:26] <kvy> but
[15:26] <kvy> that
[15:27] <bhavin192> kvy, i or I ?
[15:27] <kvy> do'nt accept anything.
[15:27] <kvy> <eof>
[15:27] <kushal> next
[15:28] <kushal> Roll Call for tonight
[15:28] <bhavin192> kvy, sorry but I want to break your habit of i :P
[15:28] <shankarj67> kvy, codechef is online competetive programming platform to improve
your coding and algorithm skills.
[15:28] <kushal> Kushal Das
[15:28] <sayan> ahole[m]: you really don't do that in day to day life, but while building
architectures for a product you generally need these skills
[15:28] <nisha_> Nisha Rani
[15:28] <bhavin192> Bhavin Gandhi
[15:28] <abhinavshirur[m]> Abhinav Shirur
[15:28] <avik> Avik Mukherjee
[15:28] <skarpy> Akash pathak
[15:28] <anuGupta> Anu Kumari Gupta
[15:28] <im_mohsin> Mohsin Mumtaz
[15:28] <niranjana> Niranjana Deshpande
[15:28] <pr97> Priyanka Sharma
[15:28] <mbtamuli12_> Mriyam Tamuli
[15:28] <shankarj67> shankar jha
[15:28] <rahuldecoded_> Rahul Bhattacharjee
[15:28] <dodococo> Deepak Chethan
[15:28] <singh123> Amarjeet singh
[15:28] <messifc> Messi Fc
[15:28] <jasonbraganza> Jason Braganza
[15:28] <dhairyya> Dhairyya Agarwal
[15:28] <wrik003> !
[15:28] <RJ722> Rahul Jha
[15:28] <saikat195> Saikat Dey
[15:28] <meamitk> Amit Kokitkar
[15:28] <ashwanig> Ashwani Kumar Gupta
[15:28] <santoshShaw[m]> Santosh Kumar Shaw
[15:28] <proishan11_> Ishan Singh
[15:28] <vivek_> Vivek Anand
[15:28] <shivamA1> Shivam Ahirao
[15:28] <sapahia> Rishav Sapahia
[15:28] <ravindra> Ravindra Lakal
[15:28] <balaji> Balaji
[15:28] <kvy> bhavin192 It's all write.
[15:28] <wrik003> Wrik Bhadra
[15:28] <akshayg96[m]> Akshay Gaikwad
[15:28] <shreyab25> Shreha Bhandare
[15:28] <deepika> Deepika Upadhyay
[15:28] <acetakwas> Tosin Animashaun
[15:28] <Priyansh> Priyansh
[15:28] <amritha97> Amritha Sharma
[15:28] <devesh_verma_> Devesh Verma
[15:28] <mdbk_> Onyine Madubuko
[15:28] <ahole[m]> Kshithij Iyer
[15:28] <kvy> kumar vipin yadav
[15:28] <sitlanigaurav[m]> Gaurav Sitlani
[15:28] <cran-cg> Chiranjeev Gupta
[15:28] <geekodour08> Hrishikesh Barman
[15:28] <RatanShreshtha> Ratan Kulshreshtha
[15:29]   <anupamas> Anupama Shipurkar
[15:29]   <bhargav> Bhargav Tamuli
[15:29]   <CuriousLearner> Sanyam Khurana
[15:29]   <subho> Subhendu Ghosh
[15:29]   <sayan> Sayan Chowdhury
[15:29]   <zebak_> Zeba Karin
[15:29]   <fhackdroid> Farhaan Bukhsh
[15:29]   <rimshakhan> Rimsha Khan
[15:29]   <ndakota> Abhiram Ramesh
[15:29]   <kushal> Tomorrow we will have the session at 7pm (same time as today).
[15:30]   <wrik003> I got disconnected a few minutes ago. Did I miss anything? Is today's
session   over?
[15:30]   <kushal> wrik003, read the channel topic please
[15:30]   <neer> Nishanta Sarma
----END   CLASS----
"""
userdict = { } #value at index 0 is a marker for it's occurance ,1 for linecount and 2 for word count
loglist = log.split('[')   
nick= " "
for x in loglist :
	if x.find('<') == -1 :
		continue		
	nick=x[ x.find('<')+1 : x.find('>'): ]
	userdict.setdefault(nick,[0])
	if userdict[nick][0] == 0 :
		userdict[nick][0] = 1
...
for x in userdict :
	print("{} : \n \tLines: {} \n \t Words: {}" .format(x,userdict[x][1],userdict[x][2]))
